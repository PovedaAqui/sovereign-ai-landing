...
const translations = {
  en: {
    ...
    footer: "SA! — hardware for local AI. Designed and manufactured in the EU.",
  ...
  es: {
    ...
    footer: "SA! — hardware para IA local. Diseñado y fabricado en la UE.",
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden border-b border-[var(--color-border)] px-6 py-24 text-center">
        ...
        <div className="mt-12 w-full max-w-3xl px-6">
          <img
            ...
            alt={
              locale === "en"
                ? "Chassis of the SA! mini-PC — industrial design in black aluminum with perforated front panel"
                : "Chasis del mini-PC SA! — diseño industrial en aluminio negro con panel frontal perforado"
            }
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 overflow-x-auto">
            <table className="w-full border-collapse text-left">
              ...
              <tbody>
                {[
                  ["Qwen3-30B-A3B-Instruct", "30B (3B active)", "MoE", "IQ4_XS", "≈ 103"],
                  ["Qwen3-Coder 30B-A3B", "30B (3B active)", "MoE", "Q4_K_S", "≈ 101"],
                  ["Qwen3.6 35B-A3B", "35B (3B active)", "MoE", "Q4_K_M", "≈ 77"],
                  ["Nemotron 3 Nano 30B-A3B", "31B (3.5B active)", "MoE", "IQ4_XS", "≈ 76"],
                  ["Gemma 4 26B-A4B", "26B (4B active)", "MoE", "UD-Q4_K_M", "≈ 48"],
